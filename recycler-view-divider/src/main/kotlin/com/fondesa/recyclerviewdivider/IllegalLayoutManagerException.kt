...
private fun messageOf(
    layoutManagerClass: Class<out RecyclerView.LayoutManager>,
    suggestedBuilderClass: Class<*>?
): String = if (suggestedBuilderClass != null) {
    "Use a ${suggestedBuilderClass.simpleName} to handle dividers in a ${layoutManagerClass.simpleName}."
} else {
    "The layout manager ${layoutManagerClass.name} isn't supported."
}
